...
public class RespuestaDebitosAutomaticos extends EscritorXLS {

    private final int flag;
    private final String fecha;

    public RespuestaDebitosAutomaticos(String tipoDebito, String fecha, List<List<String>> filas, List<String> cabeceros) {
